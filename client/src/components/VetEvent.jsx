...
function VetEvent() {
  return (
    <div id="vet-event-component">

    <h1 className="title">Add Vet Visit</h1>
    ...
    <form action="reports.html">
        ...
        <br />Date of Visit: <input type="date" min="2000" max="2026" />
        <br />Vet Name/Location: <input type="text" maxLength={1500} />
